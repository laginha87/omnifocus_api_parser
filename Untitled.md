...
### <code>function <a name='DataStoreInbox.apply'>apply</a>(function: [`Function`](#Function))</code> → [`ApplyResult`](#ApplyResult) or `null`
...
### <code>var <a name='Form.validate'>validate</code></a> → [`Function`](#Function) or `null`
...
### <code>var <a name='NSMenuItem.checked'>checked</code></a> → `Boolean`
 If true, a checkmark is displayed next to the `MenuItem`'s label.
<br/><br/>


### <code>var <a name='NSMenuItem.label'>label</code></a> → `String`
...
### <code>function <a name='PlugInScriptObject.library'>library</a>(identifier: `String`)</code> → [`Object`](#Object) or `null`
...
### <code>function <a name='TimerConstructor.once'>once</a>(interval: `Number`, action: [`Function`](#Function))</code> → [`Timer`](#Timer)
...
### <code>function <a name='TimerConstructor.repeating'>repeating</a>(interval: `Number`, action: [`Function`](#Function))</code> → [`Timer`](#Timer)
...
### <code>var <a name='OAToolbarItem.image'>image</code></a> → [`Image`](#Image) or `null`


### <code>var <a name='OAToolbarItem.label'>label</code></a> → `String`


### <code>var <a name='OAToolbarItem.toolTip'>toolTip</code></a> → `String` or `null`
...
### <code>function <a name='OOTreeNode.apply'>apply</a>(function: [`Function`](#Function))</code>
...
### <code>function <a name='URLConstructor.fromString'>fromString</a>(string: `String`)</code> → [`URL`](#URL) or `null`
...
### <code>function <a name='URLWrapper.fetch'>fetch</a>(success: [`Function`](#Function), failure: [`Function`](#Function) or `null`)</code>
...
### <code>var <a name='URLWrapper.toObject'>toObject</code></a> → [`Object`](#Object) or `null` *read-only*
